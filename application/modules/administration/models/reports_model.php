		...
		if($defaulters_query->num_rows() > 0)
		{
			...
			*/
			...
			foreach($defaulters_query->result() as $leases_row)
			{
				...
				$current_arrears = $this->accounts_model->get_current_arrears($lease_id);
				$current_balance = $this->accounts_model->get_current_balance($lease_id);
				...
				{				
					...
					$rent_amount = number_format($rent_amount,0);
						...
						$report[$row_count][5] = number_format($current_arrears,0);
