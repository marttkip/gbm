...
class Personnel extends hr 
{
	...
	*/
	...
	{
		$where = 'personnel.personnel_role_id = personnel_role.personnel_role_id';
		$table = 'personnel, personnel_role';
		//pagination
		$segment = 5;
		$this->load->library('pagination');
		$config['base_url'] = site_url().'human-resource/personnel-roles/'.$order.'/'.$order_method;
	...
	*/
	public function add_personnel() 
	{
		...
		$this->form_validation->set_rules('personnel_role_id', 'Personnel Role', 'required|xss_clean');
		...
		$v_data['personnel_roles'] = $this->personnel_model->get_personnel_roles_type();
