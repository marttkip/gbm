						...
						<table class="table table-hover table-bordered col-md-12">
							...
							<tbody>
								...
								for ($m=$month; $m>=1; $m--) {
									...
									$todaymonth = str_replace('00', '0', $todaymonth);
									
							     	$total_paid = $this->accounts_model->get_months_last_debt($lease_id,$todaymonth);
							     	$last_bal = $this->accounts_model->get_months_last_arrears($todaymonth,$this_year,$lease_id);
